...
double_lena_o = double(lena_o);
g_lena = g_noise+double_lena_o; % lena with gaussian noise
...
%imwrite(mean_g, 'mean_g.jpeg', 'jpeg');
%imwrite(mean_saltp, 'mean_saltp.jpeg', 'jpeg');
